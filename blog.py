...
class BasePublicPage(BaseRequestHandler):
    def initialize(self, request, response):
        ...
        archives=Archive.all().order('-year').order('-month').fetch(36)
        alltags=Tag.all()
